...
export default class Plot extends React.Component {
  ...
  render() {
          ...
          <Form>
            <Row>
              ...
              <Col sm="6">
                ...
                <Button disabled={running} size="sm" block color="info" onClick={() => this.props.generateRandomCenters(this.state.numberOfCenters)} className="mt-4"> Generate</Button>
              </Col>
            </Row>
          </Form>
        </Card>
    ...
    <label for="customRange1">Speed: {this.state.speed} ms</label>
            <input type="range" class="custom-range" min="500" max="2500" step="100" onChange={(e) => {this.setState({speed: e.target.value})}} id="customRange1"></input>
          </fieldset>
          <Row>
            <Col sm="6">
